...
class Keyboards:
    ...
    def get_all_goals_buttons() -> InlineKeyboardMarkup:
        return InlineKeyboardMarkup(
            inline_keyboard=[
                [InlineKeyboardButton(text="Добавить цель", callback_data='save_goal'), InlineKeyboardButton(text="Удалить цель", callback_data='del_goal')],
                [InlineKeyboardButton(text="Просмотреть цели", callback_data="display_goals"),InlineKeyboardButton(text="Настроить цели", callback_data='set_up_goal')]
            ],
        )
